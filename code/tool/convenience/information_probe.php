            ...
            layui.use(['form'], function(){
                ...
                form.on('submit(submit_button)', function(data){
                    ...
                    var load = layer.load(0, {shade: false}),
                        ...
                        type = data.type,
                        key = data.key,
                        url = '<?php echo ROOT_PATH; ?>/include/back/information_probe.php?',
                    ...
                    if(!type || !key){
                        ...
                        if (type == 'generate') {
                            axios.get(url + 'type=query&key=' + key)
                                .then(function(data){
                                    var information = window.location.protocol + '//' + window.location.host + '/include/back/information_probe.php?type=record&key=' + key;
