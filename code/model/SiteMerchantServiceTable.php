...
class SiteMerchantServiceTable extends BaseTable
{

    private $table = "siteMerchantService";
    private $columns = [
        "id",
        "userId",
        "serviceTime",
    ...
    public function insertMerchantServiceData($info)
    {
    ...
    public function getMerchantServiceLists($offset=0, $limit=200)
    {
        $tag = __CLASS__ . "-" . __FILE__;
        $startTime = microtime(true);
        try {
    ...
    public function getMerchantServiceByUserIds($userIds)
    {
        $tag = __CLASS__ . "-" . __FILE__;
        $startTime = microtime(true);
        try{
    ...
    public function getMerchantServiceByUserId($userId)
    {
        $tag = __CLASS__ . "-" . __FILE__;
        $startTime = microtime(true);
        try{
