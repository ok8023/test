...
6. 对此条款的解释、修改及更新权均属于我公司所有。
    ...
    <div class="zaly_protocol_cancel" data-local-value="unagreeProtocolTip">不同意可直接关掉该浏览器Hcw3.cn</div>
</div>
...
<script id="tpl-error-info" type="text/html">
        {{errorInfo}}
        <a style='color:rgba(76,59,177,1);' target="_blank" href='https://www.hcw3.cn'>数据库常见问题汇总</a>
    </script>