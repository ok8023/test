...
<head>
    <meta charset="UTF-8">
    <title><?php if ($lang == "1") { ?>用户管理<?php } else { ?>User Management<?php } ?> - <?php echo $name; ?>聊天室 </title>
...
<script type="text/javascript">
    ...
    function searchUsers(searchValue) {
        ...
        var url = "./index.php?action=miniProgram.merchantService.manage&lang=" + getLanguage();
        var data = {
            'operation':'search',
    ...
    $(document).on("click",".setService", function () {
        ...
        $.modal({
            title: lang == 1 ? '设置商户客服' : 'Set Customer Service',
    ...
    function setCustomerService(userId)
    {
        ...
        var url = "index.php?action=miniProgram.merchantService.manage";
