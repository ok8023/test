...
<head>
    <meta charset="UTF-8">
    <title><?php if ($lang == "1") { ?>站点管理<?php } else { ?>Site Manage<?php } ?> - <?php echo $name; ?>聊天室 </title>
...
<script type="text/javascript">
    ...
    $("#see_customer_service_list").click(function () {
        var url = "/index.php?action=miniProgram.merchantService.manage&operation=see&lang=" + getLanguage();
        openPage(url);
    });

    $("#add_customer_service").click(function () {
        var url = "index.php?action=miniProgram.merchantService.manage&operation=add&lang=" + getLanguage();
        openPage(url);
    });

    $("#enable_customer_service").click(function () {
        var url = "index.php?action=miniProgram.merchantService.index&lang=" + getLanguage();
        openPage(url);
    });
