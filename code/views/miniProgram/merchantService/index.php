...
<head>
    <meta charset="UTF-8">
    <title><?php if ($lang == "1") { ?>商户客服小程序<?php } else { ?>Customer Service<?php } ?> - <?php echo $name; ?>聊天室 </title>
            ...
            <div class="item-row">
                <div class="item-body">
                    <div class="item-body-display">
                        ...
                        <?php if ($lang == "1") { ?>
                            <div class="item-body-desc">是否开启商户客服</div>
                        <?php } else { ?>
                ...
                <div class="item-row" id="site-rsa-pubk-pem" style="height: 29px;line-height: 29px;">
                    <div class="item-body" style="height: 29px;line-height: 29px;">
                        <div class="item-body-display" style="height: 29px;line-height: 29px;">
                            ...
                            <?php if ($lang == "1") { ?>
                                <div class="item-body-desc">商户客服代码(长按复制)</div>
                            <?php } else { ?>
...
<script type="text/javascript">
    ...
    function updateDataValue() {
        ...
        var url = "index.php?action=miniProgram.merchantService.index";
