...
//        var_dump(321,$request);die();
        ...
        try {
            ...
            $preSessionId = $this->registerUserForPassport($loginName, $email, $password, $nickname, $invitationCode, $sitePubkPem, $avatar);
    ...
    private function registerUserForPassport($loginName, $email, $password, $nickname, $invitationCode, $sitePubkPem, $avatar = null)
    {
        try {
            $tag = __CLASS__ . '-' . __FUNCTION__;
